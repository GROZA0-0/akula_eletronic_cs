...
class StaffListWidgets extends StatefulWidget {
  ...
  const StaffListWidgets({super.key, required this.entities});
...
class _StaffListWidgetsState extends State<StaffListWidgets> {
  ...
  Widget empData(Alerts alerts, EmployeeInfoEntities staffEntities) {
    return Expanded(
      child: FadeInUp(
        child: Container(
              ...
              children: [
                ...
                isEditingTtisRow
                    ? DropdownButton<String>(
                        dropdownColor: grey,
                        hint: Text(
                          employee.level ?? 'Postions',
                          style: GoogleFonts.aleo(
                            color: white,
                            fontWeight: FontWeight.w400,
                          ),
                        ),
                        value: staffListController.selectedlevel.isEmpty
                            ? employee.level
                            : staffListController.selectedlevel,
                        items: staffListController.staffLevels.map((
                          String value,
                        ) {
